...
int main(){
    ...
    int i[10] = {};
    int result = 0; 
    for(i[1] = 0; i[1] < 25; ++i[1]) for(i[2] = i[1] + 1; i[2] < 25; ++i[2]) for(i[3] = i[2] + 1; i[3] < 25; ++i[3]) for(i[4] = i[3] + 1; i[4] < 25; ++i[4]) for(i[5] = i[4] + 1; i[5] < 25; ++i[5]) for(i[6] = i[5] + 1; i[6] < 25; ++i[6]) for(i[7] = i[6] + 1; i[7] < 25; ++i[7]) if(IsValid(i)) result++;
    printf("%d", result);
    return 0;
}